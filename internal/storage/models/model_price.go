...
// ModelPrice stores one catalog or manual price for a scope and exact model ID.
type ModelPrice struct {
	ID                                     uint   `gorm:"primaryKey;autoIncrement"`
	PriceScopeKey                          string `gorm:"type:varchar(255);not null;uniqueIndex:idx_model_prices_scope_model,priority:1"`
	ModelID                                string `gorm:"type:varchar(255);not null;uniqueIndex:idx_model_prices_scope_model,priority:2"`
