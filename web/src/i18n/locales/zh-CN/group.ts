  ...
  group: {
    ...
    credentials: {
      ...
      subscription: {
        ...
        sync: '同步',
        syncingQuota: '正在刷新额度信息',
        bulk: {
          actions: '批量操作',
          importFiles: '批量导入',
          exportAll: '导出全部',
          refreshCurrentPage: '刷新当前页额度',
          importResult: '批量导入完成：成功 {succeeded}，失败 {failed}',
          exportSucceeded: '已导出 {count} 个账号',
          exportFailed: '无法导出账号',
          refreshResult: '额度刷新完成：成功 {succeeded}，失败 {failed}',
        },
        download: '下载凭据',
        ...
        authError: {
          ...
          outcomeUnknown: '无法确认最近一次凭据刷新结果，请重新加载账号状态后再试。',
