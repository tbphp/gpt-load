...
func TestEveryResponsesCreateChannelDeclaresStoreHandling(t *testing.T) {
	...
	want := map[ID]ResponsesStoreHandling{
		...
		Cline:            ResponsesStoreHandlingStateless,
		Groq:             ResponsesStoreHandlingStateless,
		XAI:              ResponsesStoreHandlingUpstreamManaged,
		Cerebras:         ResponsesStoreHandlingStateless,
		Mistral:          ResponsesStoreHandlingStateless,
		Nebius:           ResponsesStoreHandlingStateless,
		Parasail:         ResponsesStoreHandlingStateless,
		Wafer:            ResponsesStoreHandlingStateless,
		HuggingFace:      ResponsesStoreHandlingStateless,
		OpenCodeGo:       ResponsesStoreHandlingStateless,
		OpenCodeZen:      ResponsesStoreHandlingStateless,
