...
func (s *Server) HTTPModule() httproute.Module {
	return httproute.Module{
		...
		Routes: []httproute.Route{
			...
			controlRoute("control.codex-routing.status", http.MethodGet, "/codex-routing/status", s.handleCodexRoutingStatus),
			controlRoute("control.codex-routing.events", http.MethodGet, "/codex-routing/events", s.handleCodexRoutingEvents),
			controlRoute(
				"control.codex-routing.probe",
				http.MethodPost,
				"/codex-routing/probe",
				s.auditMutation(newMutationDescriptor(
					"codex_routing_probe",
					"codex_routing",
					staticMutationLocator("codex-routing"),
				)),
				s.handleCodexRoutingProbe,
			),
			controlRoute(
				"control.codex-routing.clear",
				http.MethodPost,
				"/codex-routing/clear",
				s.auditMutation(newMutationDescriptor(
					"codex_routing_clear",
