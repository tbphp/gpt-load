export default {
  ...
  keys: {
    ...
    keySelectionMode: "Key selection mode",
    subGroupSelectionMode: "Sub-group selection mode",
    validationPayloadMode: "Validation payload mode",
    validationPayloadChat: "Chat payload",
    validationPayloadResponsesSimple: "Responses simple payload",
    validationPayloadResponsesMessages: "Responses message payload",
  ...
  subGroups: {
    ...
    sortedByPriority: "Sorted by priority descending",
    noSubGroups: "No sub groups",
