...
type SystemSettings struct {
	...
	RateLimitCooldownSeconds     int `json:"rate_limit_cooldown_seconds" default:"60" name:"config.rate_limit_cooldown" category:"config.category.key" desc:"config.rate_limit_cooldown_desc" validate:"required,min=0"`
