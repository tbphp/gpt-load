export default {
  ...
  keys: {
    ...
    editModels: "Edit allowed models",
    editKeyModels: "Edit allowed models",
    enterModels: "Enter model names, comma-separated (e.g. deepseek-v4-pro-0813,glm-5.2)",
    modelsUpdated: "Allowed models updated",
    modelsUpdateFailed: "Failed to update allowed models",
    modelsLabel: "Models",
    modelsHint: "Comma-separated model names the key may serve. Leave empty to allow all models.",
