  ...
  group: {
    ...
    credentials: {
      ...
      subscription: {
        ...
        rediscoverLocal: 'Rediscover local account',
        rediscoverLocalSucceeded: 'Switched to the new local account',
        rediscoverLocalFailed: 'Unable to rediscover the local account',
        rediscoverSameAccount: 'Still the current local account',
        rediscoverNoLocalAccount: 'No local primary account found',
