  ...
  group: {
    ...
    credentials: {
      ...
      subscription: {
        ...
        sync: 'Sync',
        syncingQuota: 'Refreshing quota information',
        bulk: {
          actions: 'Bulk actions',
          importFiles: 'Import files',
          exportAll: 'Export all',
          refreshCurrentPage: 'Refresh this page',
          importResult: 'Bulk import complete: {succeeded} succeeded, {failed} failed',
          exportSucceeded: 'Exported {count} account(s)',
          exportFailed: 'Unable to export accounts',
          refreshResult: 'Quota refresh complete: {succeeded} succeeded, {failed} failed',
        },
