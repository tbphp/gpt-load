...
func TestExternalDatabaseLifecycle(t *testing.T) {
	...
	if len(migrationIDs) != 11 || migrationIDs[0] != "0001_initial" ||
		...
		migrationIDs[8] != "0009_price_multipliers" || migrationIDs[9] != "0010_model_cooldown" || migrationIDs[10] != "0011_custom_access_keys" {
