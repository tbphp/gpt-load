export default {
  ...
  home: {
    ledger: {
      ...
      recentRequest: {
        label: 'Last request',
        loading: 'Loading the last request…',
        empty: 'No requests yet · copy the configuration above and send one from your client',
        error: 'Cannot load the last request right now',
