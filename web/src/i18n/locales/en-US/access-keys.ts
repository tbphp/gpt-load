export default {
  accessKeys: {
    ...
    drawer: {
      ...
      groupDangling: 'No longer in the current Group catalog',
      groupSelectorLabel: 'Select Groups',
      modelSelectorLabel: 'Select models',
      searchGroups: 'Search Groups',
      searchGroupsPlaceholder: 'Search by name or ID',
      ...
      protocolUnsupported: 'Unsupported by the selected Groups',
