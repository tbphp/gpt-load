...
func TestDataPlaneEndpointCatalogDeclaresCompleteHTTPRoutes(t *testing.T) {
	...
	want := []struct {
		...
		{name: "data.mistral.voices", methods: []string{http.MethodGet, http.MethodPost, http.MethodPatch, http.MethodDelete, http.MethodHead}, path: "/mistral/v1/audio/voices"},
		{name: "data.mistral.voices.resource", methods: []string{http.MethodGet, http.MethodPost, http.MethodPatch, http.MethodDelete, http.MethodHead}, path: "/mistral/v1/audio/voices/*resource_path"},
		...
		{name: "data.mistral.files", methods: []string{http.MethodGet, http.MethodPost, http.MethodPut, http.MethodPatch, http.MethodDelete, http.MethodHead}, path: "/mistral/v1/files"},
		{name: "data.mistral.files.resource", methods: []string{http.MethodGet, http.MethodPost, http.MethodPut, http.MethodPatch, http.MethodDelete, http.MethodHead}, path: "/mistral/v1/files/*resource_path"},
		{name: "data.mistral.batch", methods: []string{http.MethodGet, http.MethodPost, http.MethodPut, http.MethodPatch, http.MethodDelete, http.MethodHead}, path: "/mistral/v1/batch"},
		{name: "data.mistral.batch.resource", methods: []string{http.MethodGet, http.MethodPost, http.MethodPut, http.MethodPatch, http.MethodDelete, http.MethodHead}, path: "/mistral/v1/batch/*resource_path"},
		{name: "data.mistral.agents", methods: []string{http.MethodGet, http.MethodPost, http.MethodPut, http.MethodPatch, http.MethodDelete, http.MethodHead}, path: "/mistral/v1/agents"},
		{name: "data.mistral.agents.resource", methods: []string{http.MethodGet, http.MethodPost, http.MethodPut, http.MethodPatch, http.MethodDelete, http.MethodHead}, path: "/mistral/v1/agents/*resource_path"},
		{name: "data.mistral.conversations", methods: []string{http.MethodGet, http.MethodPost, http.MethodPut, http.MethodPatch, http.MethodDelete, http.MethodHead}, path: "/mistral/v1/conversations"},
		{name: "data.mistral.conversations.resource", methods: []string{http.MethodGet, http.MethodPost, http.MethodPut, http.MethodPatch, http.MethodDelete, http.MethodHead}, path: "/mistral/v1/conversations/*resource_path"},
