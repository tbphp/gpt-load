  ...
  group: {
    ...
    credentials: {
      ...
      subscription: {
        title: '账号',
        emptyTitle: '尚未连接账号',
        emptyDescription: '连接一个 ChatGPT 订阅账号后即可开始路由请求。',
        connect: '连接账号',
        connectDescription: '登录 ChatGPT 完成授权后，账号会自动加入当前分组。',
        reauthorizeDescription: '正在更新 {account} 的授权，新的登录必须属于同一账号。',
        confirmConnect: '添加账号',
        ...
        authError: {
          refreshRejected: 'Codex 已拒绝刷新凭据，请重新登录该账号。',
          identityChanged: '刷新结果属于其他账号，请重新登录原账号。',
          outcomeUnknown: '无法确认最近一次凭据刷新结果，请重新登录后再使用。',
