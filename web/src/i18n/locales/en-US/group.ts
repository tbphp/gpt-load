  ...
  group: {
    ...
    credentials: {
      ...
      subscription: {
        ...
        connectDescription: 'Sign in with ChatGPT to add the account to this group.',
        ...
        estimate: {
          ...
          exactData: 'Exact request logs',
          approximateData: 'Hourly aggregate with approximate window boundaries',
          partialUsage: 'Some requests have incomplete usage',
          partialPricing: 'Some requests have no reference price',
          unavailable: 'No local usage recorded',
          noteSeparator: ' · ',
          windowSeparator: ', ',
        },
        auth: {
