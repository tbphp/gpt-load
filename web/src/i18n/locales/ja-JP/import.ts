export default {
  import: {
    ...
    subscription: {
      ...
      description:
        'ChatGPT のサブスクリプションアカウントを接続するか、既存の auth.json を読み込みます',
      securityNotice:
        'ブラウザーはアクセス認証情報を保存しません。サーバー側で暗号化して保持し、グループ作成時にのみ書き込みます。',
      authorize: 'ChatGPT でログイン',
      authorizeFailed: 'ChatGPT ログインを完了できません',
      popupBlocked: 'ポップアップがブロックされました。下の「再度開く」から続行してください。',
      waiting: '認証の完了を待っています…',
      sessionExpiresIn: '認証セッションは {countdown} 後に失効します',
      restart: 'やり直す',
      readyNotice: 'アカウントは準備完了です。グループ作成時に書き込まれます',
      authorizationLink: '認証リンク',
      copyAuthorization: 'リンクをコピー',
      openAuthorization: '再度開く',
