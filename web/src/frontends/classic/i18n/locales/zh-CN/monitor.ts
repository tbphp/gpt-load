  ...
  monitor: {
    ...
    inspector: {
      ...
      operations: {
        ...
        mistral_ocr: 'OCR',
        mistral_fim: '代码补全',
        mistral_audio_transcription: '语音转写',
        mistral_audio_speech: '语音合成',
        mistral_moderation: '文本审核',
        mistral_chat_moderation: '对话审核',
        mistral_classification: '分类',
        mistral_files: '文件',
        mistral_batch: '批处理',
        mistral_agents: '智能体',
        mistral_conversations: '会话',
        mistral_voices: '音色',
        mistral_realtime_transcription: '实时转写',
      },
      routeRequirements: {
        any: '允许协议转换（可有损）',
        native: '必须使用原生路由',
