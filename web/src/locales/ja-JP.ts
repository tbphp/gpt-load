export default {
  ...
  keys: {
    ...
    addSubGroupSuccess: "サブグループを正常に追加しました",
    addSubGroupFailed: "サブグループの追加に失敗しました",
    updateWeightSuccess: "ウェイトを正常に更新しました",
    updateWeightFailed: "ウェイトの更新に失敗しました",
  ...
  subGroups: {
    ...
    removeSuccess: "サブグループが正常に削除されました",
    deleteFailed: "サブグループの削除に失敗しました",
    editWeight: "重みを編集",
    weight: "重み",
    remove: "削除",
    groupInfo: "グループ情報",
