...
func TestSettingsHTTPStableSuccessEnvelopeUpdateAndReset(t *testing.T) {
	...
	const wantDefault = `{"code":0,"data":{"overrides":[],"values":{"first_byte_timeout":120,"header_rules":{"remove":[],"set":{}},"inject_usage_options":true,"models_dev_auto_sync_enabled":true,"request_log_retention_days":7,"request_timeout":600,"stream_idle_timeout":300,"validation_interval":600}},"message":"Success"}`
	...
	const wantUpdate = `{"code":0,"data":{"overrides":["header_rules","request_timeout"],"values":{"first_byte_timeout":120,"header_rules":{"remove":[],"set":{}},"inject_usage_options":true,"models_dev_auto_sync_enabled":true,"request_log_retention_days":7,"request_timeout":900,"stream_idle_timeout":300,"validation_interval":600}},"message":"Success"}`
