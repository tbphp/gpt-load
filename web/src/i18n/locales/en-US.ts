export default {
  ...
  monitor: {
    ...
    health: {
      ...
      status: {
        empty: 'No keys',
        unavailable: 'No keys are currently available',
        available: '{count} keys available',
      },
      summary: {
        title: 'Runtime health',
        description: 'States and raw counters exposed by the current runtime snapshot.',
