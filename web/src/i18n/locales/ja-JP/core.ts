export default {
  ...
  home: {
    ledger: {
      ...
      recentRequest: {
        label: '直近のリクエスト',
        loading: '直近のリクエストを読み込み中…',
        empty: 'まだリクエストがありません · 上の設定をコピーしてクライアントから送信してください',
        error: '直近のリクエストを読み込めません',
        unknownModel: '不明なモデル',
        success: '成功',
        canceled: 'キャンセル',
        incomplete: '未完了',
        ...
        reasons: {
          notSent: '上流に未送信',
          rateLimited: '上流でレート制限',
          unauthorized: '認証情報が拒否されました',
          notFound: 'モデルまたはパスが見つかりません',
          timeout: 'タイムアウト',
          upstream: '上流エラー',
          badRequest: '不正なリクエスト',
          unknown: '失敗',
