export default {
  ...
  group: {
    ...
    credentials: {
      ...
      emptyTitle: 'No channel credentials',
      emptyDescription: 'Import a credential into this Group to begin routing requests.',
      ...
      caption: 'Channel credentials for this Group',
      auto: 'Auto',
      none: '—',
      notScheduled: '—',
      notScheduledHelp: 'This credential is not participating in scheduling',
      selectCredential: 'Select credential {mask}',
      selectVisible: 'Select all credentials on this page',
      copy: 'Copy channel credential',
      ...
      subscription: {
        ...
        noModelConstraints: 'The upstream has not supplied any model-specific limits',
        ...
        observation: {
          ...
          refreshing: 'Syncing entitlement information',
