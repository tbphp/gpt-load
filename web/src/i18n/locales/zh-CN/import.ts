export default {
  import: {
    ...
    subscription: {
      title: '订阅账号',
      description: '连接你的 ChatGPT 订阅账号，或导入已有的 auth.json 文件',
      securityNotice: '浏览器不会保存访问凭据；服务端加密暂存，创建分组时才正式写入。',
      authorize: '使用 ChatGPT 登录',
      authorizeFailed: '无法完成 ChatGPT 登录',
      popupBlocked: '弹窗被浏览器拦截，请点击下方的“重新打开”继续',
      waiting: '等待授权完成…',
      sessionExpiresIn: '授权会话 {countdown} 后失效',
      restart: '重新开始',
      readyNotice: '账号已就绪，创建分组时写入',
