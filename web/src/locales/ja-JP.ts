export default {
  ...
  keys: {
    ...
    clearCurrentQueryKeys: "現在のクエリキーをクリア",
    confirmClearCurrentQueryKeys: "現在のクエリ条件のキーをクリアしてもよろしいですか？\nクエリ条件：{query}",
    clearCurrentQueryKeysSuccess: "現在のクエリ条件のキーが正常にクリアされました",
    clearCurrentQueryKeysFailed: "現在のクエリキーのクリアに失敗しました",
    allStatus: "すべてのステータス",
    keyExactMatch: "キー完全一致",
    keySearch: "キー検索",
    statusCodeSearch: "ステータスコード検索",
    statusCodeSearchPlaceholder: "ステータスコードを入力...",
    searchByName: "名前で検索...",
