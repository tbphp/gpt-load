export default {
  ...
  keys: {
    ...
    clearCurrentQueryKeys: "Clear Current Query Keys",
    confirmClearCurrentQueryKeys: "Are you sure to clear keys under current query conditions?\nQuery conditions: {query}",
    clearCurrentQueryKeysSuccess: "Keys under current query conditions cleared successfully",
    clearCurrentQueryKeysFailed: "Failed to clear current query keys",
    allStatus: "All Status",
    keyExactMatch: "Key exact match",
    keySearch: "Key Search",
    statusCodeSearch: "Status Code Search",
    statusCodeSearchPlaceholder: "Enter status code...",
