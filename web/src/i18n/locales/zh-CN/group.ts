export default {
  ...
  group: {
    ...
    copySuccess: '已复制',
    copyFailure: '复制失败',
    connectionType: { api_key: 'API Key', subscription: '订阅' },
    modelEditor: {
      title: '模型与别名',
    ...
    credentials: {
      ...
      emptyTitle: '尚无渠道凭据',
      emptyDescription: '向此 Group 导入凭据后即可开始路由请求。',
      emptyFilterTitle: '没有符合条件的凭据',
      emptyFilterDescription: '调整搜索或状态筛选后再试',
      caption: '此 Group 的渠道凭据',
      auto: '自动',
      none: '—',
      notScheduled: '—',
      notScheduledHelp: '此凭据当前不参与调度',
      selectCredential: '选择凭据 {mask}',
      selectVisible: '选择当前页全部凭据',
      copy: '复制渠道凭据',
      cardLabel: '渠道凭据 {mask}',
      ...
      subscription: {
        connect: '连接订阅账号',
        connectDescription: '完成浏览器 OAuth 或导入认证文件后，再将临时账号保存到当前分组。',
        confirmConnect: '添加账号',
        connectFailed: '无法将订阅账号添加到当前分组',
        reauthorize: '重新授权',
        confirmReauthorize: '更新授权',
        reauthorizeFailed: '无法更新该订阅账号的授权',
        manage: '管理账号',
        sync: '同步上游信息',
        syncFailed: '无法同步订阅账号的上游信息',
        drawerTitle: '订阅账号',
        drawerDescription: '管理账号授权、动态权益与运行时状态',
        account: '账号',
        plan: '套餐',
        resetCredits: '可用重置次数',
        authLabel: '授权状态',
        ...
        noModelConstraints: '上游尚未提供模型专项限制',
        unknown: '上游未提供',
