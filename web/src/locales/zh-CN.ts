export default {
  ...
  keys: {
    ...
    clearCurrentQueryKeys: "清空当前查询密钥",
    confirmClearCurrentQueryKeys: "确定要清空当前查询条件下的密钥吗？\n查询条件：{query}",
    clearCurrentQueryKeysSuccess: "当前查询条件下的密钥已清空成功",
    clearCurrentQueryKeysFailed: "清空当前查询密钥失败",
    allStatus: "全部状态",
    keyExactMatch: "Key 精确匹配",
    keySearch: "密钥搜索",
    statusCodeSearch: "状态码搜索",
    statusCodeSearchPlaceholder: "输入状态码...",
