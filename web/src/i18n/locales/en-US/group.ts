  ...
  group: {
    ...
    settings: {
      ...
      base: {
        ...
        providerClearSearch: 'Clear provider search',
        providerCustom: 'Custom provider',
        providerHelp: 'Provider identity and upstream URL are saved independently',
        providerLoadFailed: 'Unable to load provider suggestions',
        name: 'Name',
