...
type SystemSettings struct {
	...
	SkipCertVerify        bool   `json:"skip_cert_verify" default:"false" name:"config.skip_cert_verify" category:"config.category.request" desc:"config.skip_cert_verify_desc"`
