...
func TestAutoMigrateRewritesRetiredForkPriorityManualLedger(t *testing.T) {
	...
	for _, retiredID := range []string{"0021_priority_manual", "0022_priority_manual"} {
		t.Run(retiredID, func(t *testing.T) {
			...
			wantTail := []string{"0020_client_model_overrides", "0021_request_audit", "0022_rpm_stats", "0023_priority_manual"}
