  ...
  group: {
    ...
    settings: {
      ...
      parameterOverrides: {
        ...
        conditions: '匹配条件',
        protocol: '协议',
        protocolHelp: '留空匹配全部协议。',
        model: '模型',
        modelHelp: '精确匹配，或使用末尾 * 匹配模型前缀。',
        modelNoMatch: '当前分组没有匹配模型；仍可保存。',
        allProtocolWarning: '此规则会作用于全部支持的协议，请确认参数名称在各协议中兼容。',
        allProtocols: '全部协议',
        allModels: '全部模型',
        set: '设置参数',
        setHelp: '填写 JSON 对象；对象递归合并，数组和标量整体替换。变量不会展开。',
        setPlaceholder: "{'{'}\n  \"temperature\": 0.7\n{'}'}",
        formatJSON: '格式化 JSON',
        remove: '删除参数',
        removeHelp: '使用以 / 开头的对象字段路径；不支持数组索引。',
        addRemove: '添加路径',
        removePath: '删除路径',
