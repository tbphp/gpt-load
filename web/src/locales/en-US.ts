export default {
  ...
  keys: {
    ...
    addSubGroupSuccess: "Sub group added successfully",
    addSubGroupFailed: "Failed to add sub group",
    updateWeightSuccess: "Weight updated successfully",
    updateWeightFailed: "Failed to update weight",
  ...
  subGroups: {
    ...
    removeSuccess: "Sub group removed successfully",
    deleteFailed: "Failed to remove sub group",
    editWeight: "Edit Weight",
    weight: "Weight",
    remove: "Remove",
