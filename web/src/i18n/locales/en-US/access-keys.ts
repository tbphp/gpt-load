  ...
  accessKeys: {
    ...
    drawer: {
      ...
      costLimits: {
        ...
        windowEnds: 'Current period ends:',
        note: 'Costs are estimated from configured model prices; unpriced requests add $0. Changing only the amount preserves usage, while changing the period ends the old window.',
      },
