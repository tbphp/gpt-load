export default {
  ...
  shell: {
    ...
    menu: '菜单与偏好设置',
    preferences: '偏好设置',
    accessKeyReadOnly: 'AccessKey · 只读',
    accessKeyReadOnlyDescription:
      '当前使用 AccessKey 登录；页面和数据仅限此密钥，不能修改系统配置。',
    language: '语言',
    theme: '主题',
    localeZh: '简体中文',
    localeEn: 'English',
