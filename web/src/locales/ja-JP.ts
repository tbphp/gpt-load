export default {
  ...
  keys: {
    ...
    editModels: "利用可能モデルを編集",
    editKeyModels: "キーの利用可能モデルを編集",
    enterModels: "モデル名をカンマ区切りで入力（例: deepseek-v4-pro-0813,glm-5.2）",
    modelsUpdated: "利用可能モデルが更新されました",
    modelsUpdateFailed: "利用可能モデルの更新に失敗しました",
    modelsLabel: "利用可能モデル",
    modelsHint: "カンマ区切りのモデル名。このキーはこれらのモデルのみを提供します。空欄は制限なし。",
