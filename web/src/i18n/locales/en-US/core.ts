export default {
  ...
  home: {
    ledger: {
      ...
      welcomeStep1: 'Import an upstream key and confirm its provider and credentials.',
      welcomeStep2: 'Create a routable Group for models and protocols.',
      welcomeStep3: 'Create an AccessKey, then connect your client.',
      ranking: {
