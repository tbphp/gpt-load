export default {
  ...
  keys: {
    ...
    needAtLeastOneActiveSubGroup: "至少需要一个权重大于0的活跃子分组",
    ...
    aggregateChannelTypeTooltip: "聚合分组的所有子分组必须是相同的渠道类型",
    ...
    addSubGroupSuccess: "添加子分组成功",
    addSubGroupFailed: "添加子分组失败",
    updateWeightSuccess: "更新权重成功",
    updateWeightFailed: "更新权重失败",
    enterWeight: "请输入权重",
  ...
  subGroups: {
    ...
    removeSuccess: "移除子分组成功",
    deleteFailed: "移除子分组失败",
    editWeight: "编辑权重",
    weight: "权重",
    remove: "移除",
    groupInfo: "分组信息",
