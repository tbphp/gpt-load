  ...
  group: {
    ...
    settings: {
      ...
      parameterOverrides: {
        ...
        orderHelp: 'Matching rules run from top to bottom; later rules take precedence.',
        addRule: 'Add rule',
        ...
        protocol: 'Protocol',
        protocolHelp: 'Leave empty to match every protocol.',
        model: 'Model',
        modelHelp: 'Match exactly or use one trailing * for a model prefix.',
        modelNoMatch: 'No current Group model matches; the rule can still be saved.',
        allProtocolWarning:
        ...
        set: 'Set parameters',
        setHelp:
          'Enter a JSON object. Objects merge recursively; arrays and scalars replace. Variables stay literal.',
        setPlaceholder: "{'{'}\n  \"temperature\": 0.7\n{'}'}",
        formatJSON: 'Format JSON',
        remove: 'Remove parameters',
        removeHelp: 'Use object-field paths starting with /. Array indexes are not supported.',
        addRemove: 'Add path',
        removePath: 'Removal path',
