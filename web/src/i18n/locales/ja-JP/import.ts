  ...
  import: {
    ...
    models: {
      ...
      descriptionSubscription:
        '空のままでも Group を作成できます。アカウントを接続すると上流のモデル一覧を取得できます。',
      tableLabel: '公開予定モデル',
      id: 'モデル ID',
      alias: '公開モデル名',
      source: '価格設定状況',
    ...
    conflict: {
      ...
      titleSubscription: 'Codex の Group は既に存在します',
      description: '既存 Group に認証情報を追加するか、別の Group を作成してください',
      descriptionSubscription: '既存 Group にアカウントを追加するか、別の Group を作成してください',
      close: 'URL 競合を閉じる',
