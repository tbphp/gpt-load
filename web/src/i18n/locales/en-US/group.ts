export default {
  ...
  group: {
    ...
    settings: {
      ...
      parameterOverrides: {
        description:
          'Modify this Group’s generation and embedding requests in order. Model lists, token counting, Responses resource operations, and probes are unaffected. Values are stored as plaintext; do not enter credentials.',
        orderHelp: 'Every matching rule runs from top to bottom; later rules take precedence.',
        addRule: 'Add rule',
        emptyTitle: 'Request parameters are unchanged',
        emptyDescription: 'Add a rule to modify matching inference requests only.',
        rule: 'Rule {position}',
        summary: 'Set {set} · remove {remove}',
        moved: 'Rule moved to position {position}',
        moveUp: 'Move rule up',
        moveDown: 'Move rule down',
        copy: 'Copy rule',
        deleteRule: 'Delete rule',
        conditions: 'Match conditions (optional)',
        protocol: 'Request protocol',
        protocolHelp: 'Leave empty for every protocol. Values use the client request protocol.',
        model: 'Request model',
        modelHelp: 'Matches the client-visible model exactly or by a trailing * prefix wildcard.',
        modelNoMatch:
          'No current public model matches; the rule can still be saved for future models.',
        allProtocolWarning:
          'This rule applies to every supported protocol. Ensure its parameter names are compatible.',
        allProtocols: 'All protocols',
        allModels: 'All models',
        set: 'Set parameters',
        setHelp:
          "Enter a JSON object to add or override. Objects merge recursively; arrays and scalars replace. Variables are not supported; {'$'}{'{'}...{'}'} is sent as a literal string.",
        setPlaceholder: "{'{'}\n  \"temperature\": 0.7\n{'}'}",
        formatJSON: 'Format JSON',
        remove: 'Remove parameters',
        removeHelp:
          'Enter object-field paths starting with /. Remove or replace arrays as a whole.',
        addRemove: 'Add removal path',
        removePath: 'Parameter removal path',
        deleteRemove: 'Delete removal path',
        protocols: {
        ...
        errors: {
          ...
          removePointer:
            'The path must start with /, use valid ~0 and ~1 escapes, and contain no array index.',
          removeDuplicate: 'Removal paths must be unique.',
          actionRequired: 'Set at least one parameter or add one removal path.',
        },
      },
