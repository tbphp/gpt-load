...
func Cline() spec.Module {
	return spec.Module{Definition: spec.Definition{
		ID: spec.Cline, Name: "Cline", Mark: "CL", Icon: "cline",
		SearchTerms: []string{"clinepass", "cline pass"},
		...
		Provider: spec.ProviderBinding{
			ProviderKind:   spec.ProviderCline,
			EndpointPolicy: spec.EndpointFixedWithOverride,
			FixedBaseURL:   "https://api.cline.bot/api/v1",
		},
		Routes: []spec.Route{
