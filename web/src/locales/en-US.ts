export default {
  ...
  keys: {
    ...
    modelRedirectPolicyTooltip: "Choose how to handle requests for models not configured in redirect rules",
    ...
    modelRedirectStrictWarning: "In strict mode, only models configured in redirect rules below can be requested, other models will return 404 error",
    modelRedirectLooseInfo: "In loose mode, models without redirect configuration will be passed directly to upstream service",
    modelRedirectRules: "Model Redirect Rules",
    modelRedirectRulesTooltip: "Configure model redirect rules, key is the model name requested by user, value is the actual model name sent to upstream",
    modelRedirectRulesPlaceholder: '{"gpt-4": "gpt-4-turbo", "gemini-2.5-flash": "gemini-2.5-flash-thinking"}',
    modelRedirectRulesDescription: "Configure model redirect rules, key is the model name requested by user, value is the actual model name sent to upstream",
    modelRedirectStrictModeNote: "In strict mode, this configuration also serves as a model whitelist",
