  ...
  monitor: {
    ...
    health: {
      ...
      groups: {
        title: 'Group ヘルス',
        description:
          '現在利用可能な認証情報だけを示し、特定の AccessKey、プロトコル、モデルのルート可否は保証しません。',
        empty: 'Group がありません。',
        disabled: '無効',
      ...
      problems: {
        ...
        inactiveDescription:
          'クールダウン中またはブラックリストの認証情報はありません。利用可否の設定は概要と Group ヘルスで確認してください。',
    ...
    usage: {
      ...
      options: {
        ...
        partialFailed:
          '一部の Group またはチャネル候補を読み込めません。使用量クエリは引き続き利用できます。',
      },
      filters: {
        label: '使用量レポートのフィルター',
        title: '使用量とコストを絞り込む',
        description:
          'Group、チャネル、クレデンシャル、アップストリームモデルで現在の集計範囲を絞り込みます。',
      ...
      empty: {
        ...
        description:
          '期間を変更するか、Group、チャネル、クレデンシャル、アップストリームモデルのフィルターをリセットしてください。',
      },
      kpi: {
        title: '使用量サマリー',
      ...
      breakdown: {
        title: 'ルートとアップストリームモデルの内訳',
        description:
          'バックエンド順位の集計は最終 Group、チャネル、クレデンシャル、アップストリームモデルを使用します。',
        caption: '最終ルートとアップストリームモデル別の使用量内訳',
        truncated: 'バックエンド上位 100 件の内訳のみ表示しています。',
        unattributedGroup: '未帰属 Group',
        unattributedMeta: 'Group への帰属なし',
        redactedRoute: 'ルート識別情報はマスク済み',
    ...
    inspector: {
      ...
      empty: {
        ...
        description:
          '現在の設定スナップショットにある候補 Group、認証情報の状態、除外理由を説明します。',
      },
      result: {
        title: '現在のランタイム観測',
      ...
      credentials: {
        ...
        noneReturned: 'この Group には認証情報候補が返されませんでした。',
      ...
      excluded: {
        title: '除外 Group',
        description:
          'Group 単位の除外結果のみを表示します。候補 Group を展開すると認証情報単位の理由を確認できます。',
      ...
      reasons: {
        ...
        no_credentials: 'Group にランタイム認証情報がありません',
        ...
        no_available_credential: 'Group に現在利用可能な認証情報がありません',
        unknown: '不明なルート理由',
      },
    },
    logs: {
      ...
      protocolConversion: {
        ...
        noneOrNotRecorded: '未設定または履歴ログに記録なし',
        comparisonLabel: 'プロトコルとパラメータの変換詳細',
        clientRequest: 'クライアントリクエスト',
        convertedUpstream: '変換後のアップストリーム',
        protocolAPI: 'プロトコル / API',
        model: 'モデル',
        reasoning: '推論',
        parameters: 'パラメータ詳細',
        history: '過去のログ',
        truncated: '切り捨て済み',
        redacted: 'マスク済み',
        historyUnavailable: 'この過去のログには変換パラメータが記録されていません',
        noSafeParameters: '表示できる安全なパラメータはありません',
        copyParameters: '安全なパラメータをコピー',
        parameter: 'パラメータ',
        dispositionLabel: '処理',
        captureState: {
          captured: '記録済み',
          partial: '一部記録',
          unavailable: '取得不可',
          skipped_oversize: 'リクエストが大きすぎるためスキップ',
          preflight_blocked: '変換前にブロック',
        },
        disposition: {
          preserved: '保持',
          mapped: 'マッピング',
      ...
      drawer: {
        ...
        descriptionSelfScoped: '現在の AccessKey に属するリクエスト、結果、使用量を確認します。',
        close: 'リクエストログ詳細を閉じる',
